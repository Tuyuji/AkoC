...
#define ASSERT_ELEM(elem)                                                                                              \
    {                                                                                                                  \
        int result = assert_elem_valid(elem);                                                                          \
        if (result != 0)                                                                                               \
            return result;                                                                                             \
    }
#define ASSERT_ELEM_STR(elem, expected)                                                                                \
    {                                                                                                                  \
        int result = assert_str_eq(elem, expected);                                                                    \
        if (result != 0)                                                                                               \
            return result;                                                                                             \
    }
